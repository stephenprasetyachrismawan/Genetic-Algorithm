...
def seleksi(half2elite,nonelite):
    parents_pair = []
    all_parents =[]
    ...
    probabilitas_half2elite = probabilitas(half2elite)
    a=0
    for i in half2elite:
        i['probabilitas']=probabilitas_half2elite[a]
        a+=1
        
    probabilitas_nonelite = probabilitas(nonelite)
    a=0
    for i in nonelite:
        i['probabilitas']=probabilitas_nonelite[a]
        a+=1
    
    #memasukkan probabilitas kumulatif
    
    probabilitas_kumulatif_half2elite = probabilitas_kumulatif(half2elite)
    a=0
    for i in half2elite:
        i['probabilitas_kumulatif']=probabilitas_kumulatif_half2elite[a]
        i['jadiparent']=0
        a+=1
        
    probabilitas_kumulatif_nonelite = probabilitas_kumulatif(nonelite)
    a=0
    for i in nonelite:
        i['probabilitas_kumulatif']=probabilitas_kumulatif_nonelite[a]
        i['jadiparent']=0
        a+=1
...
for i in range(1, jumlah_generasi+1) :
    ...
    semua_parent = seleksi(half2elite,nonelite)
    childtotal = crossover_mutation(semua_parent)
    nonelite_baru = subtitusi(childtotal,nonelite)
    populasi_baru=[]
    for i in nonelite_baru:
        populasi_baru.append(i)
    for i in half1elite:
        populasi_baru.append(i)
    for i in half2elite:
        populasi_baru.append(i)
